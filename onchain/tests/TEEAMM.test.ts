...
describe("TEEAMM", () => {
    ...
    it("should deploy the contract successfully", async () => {
        const { TEEAMM, MWETH } = await deployContracts();
    ...
    it("should withdraw ETH successfully", async () => {
        ...
        const balanceAfterDeposit = await TEEAMM.read.balances([wc.account.address, MWETH.address]) as bigint;
        ...
        const finalBalance = await TEEAMM.read.balances([wc.account.address, MWETH.address]) as bigint;
