...
//     /**
//      * @dev Allows users to deposit a specific amount of ETH into their balance
//      * @param amount The exact amount of ETH to deposit (must match msg.value)
//      * This function provides better clarity and interface compatibility
//      */
...
//     /**
//      * @dev Allows users to provide liquidity to the AMM pool directly from their wallet
...
//      * Protected against reentrancy attacks.
//      */
//     function addLiquidity(uint256 tokenAmount) external payable nonReentrant ensureNonZeroReserves {
...
//         // Transfer tokens directly from user's wallet
...
//     /**
//      * @dev Allows liquidity providers to withdraw their liquidity directly to their wallet
//      * @param shareAmount The number of liquidity shares to burn
//      * 
//      * Returns a proportional amount of ETH and tokens to the user's wallet.
//      * Protected against reentrancy attacks.
//      */
...
//         // Transfer ETH and tokens directly to user's wallet
